...
/*-----------------------------------------------
              @(target):= _Boehm_JProteomeRes2014.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__Boehm_JProteomeRes2014

#else
#  define SWIG_init    init_Boehm_JProteomeRes2014

#endif
#define SWIG_name    "_Boehm_JProteomeRes2014"
