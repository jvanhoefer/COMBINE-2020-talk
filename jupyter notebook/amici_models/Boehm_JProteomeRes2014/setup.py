...
def get_extension() -> Extension:
    ...
    sources = [os.path.join("swig", "Boehm_JProteomeRes2014.i"), *get_model_sources()]
    ...
    # Build shared object
    ext = Extension(
        'Boehm_JProteomeRes2014._Boehm_JProteomeRes2014',
        sources=sources,
        include_dirs=ext_include_dirs,
        libraries=libraries,
        library_dirs=ext_library_dirs,
        swig_opts=[
            '-c++', '-modern', '-outdir', 'Boehm_JProteomeRes2014',
...
setup(
    ...
    cmdclass=CMDCLASS,
    version='0.1.0',
    description='AMICI-generated module for model Boehm_JProteomeRes2014',
